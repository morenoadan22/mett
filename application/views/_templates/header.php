...
<head>
    ...
    <title>SDSU Masters Exam Tracking Tool</title>
...
<body>
    ...
    <div class='title-box'>
        <a href="<?php echo URL; ?>">San Diego State University - Masters Exam Tracking Tool</a>
    </div>
    ...
    <div class="header">
        ...
        <ul id="menu">
            ...
            <li <?php if ($this->checkForActiveController($filename, "results")) { echo ' class="active" '; } ?> >
                <a href="<?php echo URL; ?>results/index">Exam Results</a>
            </li>
            <?php endif; ?>
            <?php if (Session::get('user_logged_in') == true):?>
            <li <?php if ($this->checkForActiveController($filename, "history")) { echo ' class="active" '; } ?> >
