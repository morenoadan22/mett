...
define('COOKIE_DOMAIN', '.ec2-54-183-228-165.us-west-1.compute.amazonaws.com');
 ...
 * (@see https://github.com/panique/mett/wiki/Which-hashing-&-salting-algorithm-should-be-used-%3F)
...
define("EMAIL_SMTP_USERNAME", 'sdsu.mett@gmail.com');
// SMTP provider password
define("EMAIL_SMTP_PASSWORD", 'sdsumettcs532');
// SMTP provider port
define("EMAIL_SMTP_PORT", 465);
 ...
 *
 * mett uses the PHPMailer library, please have a look here if you want to add more
 ...
 * define("EMAIL_PASSWORD_RESET_URL", "http://127.0.0.1/mett/4-full-mvc-framework/login/passwordReset");
 ...
 * define("EMAIL_VERIFICATION_URL", "http://127.0.0.1/mett/4-full-mvc-framework/login/verify/");
